...
}`;return{model:b,migration:v,routes:m,controller:x,storeRequest:(r,h=[])=>$(r,h,"Store"),updateRequest:(r,h=[])=>$(r,h,"Update")}},{Panel:oe}=D;function ye({auth:c}){const{handleFileUpload:o,data:s,handleReset:b,contextHolder:v,beforeUpload:m}=G(route("admin.excel.database_import")),{data:x,post:$,reset:i,setData:p,processing:r,errors:h}=O({excel_file:null}),{migration:g,model:e,routes:a,controller:t,storeRequest:n,updateRequest:u}=se(),[l,f]=_.useState(10),y=R=>{f(R)},k=N("csrf-token"),w=R=>{R.preventDefault(),$(route("admin.excel.database_import"),{onFinish:()=>i("excel_file")})},P={showLineNumbers:!0,startingLineNumber:1,wrapLines:!1,theme:J,codeBlock:!1},L=Object.keys((s==null?void 0:s.data)||[]).map((R,j)=>{var C;return{label:R,value:j,modelName:R,migrationData:(((C=s==null?void 0:s.data)==null?void 0:C[R])||[]).filter(E=>!!E.name)}}),T=[{key:10,label:"Migration"},{key:11,label:"Model"},{key:12,label:"Route"},{key:13,label:"Controller"},{key:14,label:"Store Request"},{key:15,label:"Update Request"}],B=[{key:10,label:"Migration",functionName:g},{key:11,label:"Model",functionName:e},{key:12,label:"Route",functionName:a},{key:13,label:"Controller",functionName:t},{key:14,label:"Store Request",functionName:n},{key:15,label:"Update Request",functionName:u}];return d.jsxs(K,{user:c.user,header:d.jsx("h2",{className:"font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight",children:"Database"}),children:[d.jsx(V,{title:"Database"}),v,d.jsx("div",{className:"py-12",children:d.jsxs("div",{className:"max-w-7xl mx-auto sm:px-6 lg:px-8",children:[d.jsx(Q,{}),d.jsxs(I,{children:[d.jsx(X,{title:"Excel Database Migration"}),d.jsxs("form",{onSubmit:w,action:"/a/excel/database",method:"POST",encType:"multipart/form-data",children:[d.jsx("input",{type:"hidden",name:"_token",value:k}),d.jsx("div",{children:d.jsx(te,{name:"excel_file",onChange:o,beforeUpload:m,action:route("admin.excel.database_import"),accept:".xls, .xlsx",children:d.jsx(W,{icon:d.jsx(Y,{}),children:"Click to Upload"})})})]})]}),s?d.jsx(I,{children:d.jsx(ee,{tabPosition:"left",items:L.map(({label:R,value:j,migrationData:C,modelName:E})=>{var A,F;return{label:R,key:j,children:d.jsx(I,{style:{width:"100%"},tabList:T,activeTabKey:l,onTabChange:y,tabProps:{size:"middle"},children:d.jsx(D,{defaultActiveKey:["1"],children:d.jsx(oe,{header:"Code",children:d.jsx(Z,{...P,language:"php",text:(F=(A=B.filter(H=>H.key===l))==null?void 0:A[0])==null?void 0:F.functionName(E,C)})},"1")})})}})})}):null]})})]})}export{ye as default};
